...
import org.ymessenger.app.viewmodels.ChannelEditViewModel
import java.io.File
import java.io.IOException

class ChannelEditActivity : BaseActivity() {

    private lateinit var viewModel: ChannelEditViewModel
    ...
    companion object {
        ...
        private const val TAG = "ChannelEditActivity"

        fun start(context: Context, channelId: Long) {
            val intent = Intent(context, ChannelEditActivity::class.java).apply {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val channelId =
            intent.extras?.getLong(ARG_CHANNEL_ID) ?: throw Exception("Channel id is null")
        val factory = Injection.provideChannelEditViewModelFactory(appBase, channelId)
        viewModel = ViewModelProviders.of(this, factory).get(ChannelEditViewModel::class.java)
    ...
    private fun subscribeUi(viewModel: ChannelEditViewModel) {
    ...
    private fun setChannel(channel: Channel) {
        Glide.with(this)
            ...
            .apply(RequestOptions().placeholder(R.drawable.upload_avatar))
            .into(ivPhoto)

        etName.setText(channel.name)
        etAbout.setText(channel.about)
    }
    ...
    private fun saveChat() {
        ...
        viewModel.saveChannel(name, about)
    }
    ...
    private fun updatePhoto(fileId: String) {
