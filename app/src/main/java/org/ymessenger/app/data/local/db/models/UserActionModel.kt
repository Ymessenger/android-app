...
class UserActionModel {
    ...
    fun getDisplayName(): String? {
        return getContact()?.name ?: getUser()?.fullName
    }

    fun getActionLabelRes() = userAction.getActionLabelRes()

    fun getActionPlaceholderLabelRes() = userAction.getActionPlaceholderLabelRes()
